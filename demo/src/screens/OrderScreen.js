...
export default function TransactionScreen() {
  ...
  return loading ? (
    ...
    <div>
      <Helmet>
        <title>Transaction ID: {orderId}</title>
      </Helmet>
      <h1 className="my-3">Transaction ID: {orderId}</h1>
      <Row>
        <Col md={8}>
        <Card className="mb-3">
            <Card.Body>
              ...
              <Card.Text>
                ...
                <strong>Mail: </strong> {userInfo.email}
              </Card.Text>
          ...
          <Card className="mb-3">
            <Card.Body>
              ...
              <Card.Text>
                {/* <strong>Name:</strong> {order.paymentAddress.amont} <br /> */}
